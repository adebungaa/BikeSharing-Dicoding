...
fig = px.line(monthly_users_df,
              ...
              color_discrete_sequence=["green", "orange", "white"],
              markers=True,
              title="Jumlah Pengguna Bike Sharing Bulanan (2011-2012)").update_layout(xaxis_title='', yaxis_title='Total Pengguna')
...
fig2 = px.bar(weekday_users_df,
              ...
              barmode='group',
              color_discrete_sequence=["green", "orange", "white"],
              title='Jumlah Pengguna Bike Sharing Berdasarkan Hari').update_layout(xaxis_title='', yaxis_title='Total Pengguna')
...
st.caption('Copyright (c), created by Ade Bunga')
